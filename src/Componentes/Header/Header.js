    ...
    return (
        <div className="bg-white text-black p-5">
            <div className="container mx-auto">
                ...
                <Link to="/"><h1 className="text-3xl md:text-4xl font-bold font-orelega">
                    ...
                    <div className="relative md:hidden">
                        ...
                        <Link to="/perfil"><a href="!#" className="block px-4 py-2 text-center">
                                <UserIcon className="h-4 w-4 md:h-5 md:w-5 mx-auto mb-1 text-orange-500" />
                                Perfil
                            </a></Link>
                            <Link to="/favoritos"><a href="!#" className="block px-4 py-2 text-center">
                                <StarIcon className="h-4 w-4 md:h-5 md:w-5 mx-auto mb-1 text-orange-500" />
                                Favoritos
                            </a></Link>
                            <Link to="/sair"><a href="!#" className="block px-4 py-2 text-center">
                    ...
                    <div className="hidden md:flex">
                        ...
                        <Link to="/perfil"><UserIcon className="h-5 w-5 md:h-8 md:w-8 mx-auto mb-1 text-orange-500" /></Link>
                            Perfil
                        </a>
                        <a href="!#" className="mx-3 text-center">
                        <Link to="/favoritos"><StarIcon className="h-5 w-5 md:h-8 md:w-8 mx-auto mb-1 text-orange-500" /></Link> 
                            Favoritos
                        </a>
                        <a href="!#" className="mx-3 text-center">
                        <Link to="/sair"><LogoutIcon className="h-5 w-5 md:h-8 md:w-8 mx-auto mb-1 text-orange-500" /></Link> 
                            Sair
                        </a>
                    </div>
                </div>
